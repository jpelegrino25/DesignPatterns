...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        SongComponent heavyMetalMusic=
                new SongGroup("HeavyMetal","is a genre of rock that developed in the late 1960s, largely in the UK and in the US");

        SongComponent dubstepMusic =
                new SongGroup("dubstepMusic","is a genre of electronic dance music that originated in South London, England");
